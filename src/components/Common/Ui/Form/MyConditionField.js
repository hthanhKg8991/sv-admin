...
class MyConditionField extends React.Component {
    ...
    render() {
        ...
        const conditionItems = _.get(common, Constant.COMMON_DATA_KEY_promotion_programs_condition_items);
                                    ...
                                    <div className="row margin-top-10" key={index}>
                                        <div className="col-md-5">
                                            <MySelectSystem name={`${name}.${index}.left`}
                                                            ...
                                                            type={"common"}
                                                            valueField={"value"}
                                                            idKey={Constant.COMMON_DATA_KEY_promotion_programs_condition_items}
                                                            showLabelRequired
                                            />
                                        </div>
