        ...
        return (
            <div className="box-card">
                <div className="box-card-title">
                    ...
                    <div className="right">
                        <button type="button" className="bt-refresh el-button" onClick={()=>{this.refreshFilter()}}>
                        ...
                        <div className="box-search-form">
                            <div className="form-item mb10">
                                <div className="item-content">
                                    <button type="button" className="el-button el-button-primary el-button-small w100" onClick={this.btnAdd}>
                            ...
                            {Array.isArray(this.props.children) && this.props.children.length > this.props.showQtty && !this.state.show_all && (
                                <div className="view-all mt15">
                                    <span className="text-underline text-primary pointer" onClick={this.showAll}><T>Xem thêm</T></span>
                                </div>
                            )}
                            {Array.isArray(this.props.children) && this.props.children.length > this.props.showQtty && this.state.show_all &&(
                                <div className="view-all mt15">
