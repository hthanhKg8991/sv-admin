...
class PopupAddEvent extends React.Component {
    ...
    async submitData(data) {
        ...
        if (id > 0) {
            data.id = id;
            res = await updateGamificationEvent(data);
        } else {
            res = await createGamificationEvent(data);
        }
        if (res) {
        ...
        return (
            <div className="dialog-popup-body">
                <div className="popupContainer">
                    <div className="form-container" style={{height: "170px"}}>
...
export default connect(null, mapDispatchToProps)(PopupAddEvent);
