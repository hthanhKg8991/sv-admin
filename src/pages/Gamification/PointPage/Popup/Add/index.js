...
import {
    createGamificationPoint,
    updateGamificationPoint,

} from "api/gamification";

class PopupAddPoint extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            initialForm: {
    ...
    async submitData(data) {
        ...
        if (id > 0) {
            data.id = id;
            res = await updateGamificationPoint(data);
        } else {
            res = await createGamificationPoint(data);
        }
        if (res) {
        ...
        return (
            <div className="dialog-popup-body">
                <div className="popupContainer">
                    <div className="form-container" style={{height: "200px"}}>
...
export default connect(null, mapDispatchToProps)(PopupAddPoint);
