...
class ComponentFilter extends Component {
    ...
    render() {
        ...
        const status = utils.convertArrayValueCommonData(this.props.sys.common.items,Constant.COMMON_DATA_KEY_email_marketing_list_contract_status);
        return (
            <FilterLeft idKey={idKey} query={query} menuCode={menuCode}>
                <SearchField type="input" label="ID, Tên" name="q" timeOut={1000}/>
                <SearchField type="dropbox" label="Campaign Group" name="campaign_group_id" data={campaign_group}/>
