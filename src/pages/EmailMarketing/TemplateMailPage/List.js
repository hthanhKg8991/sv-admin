...
import ComponentFilter from "pages/EmailMarketing/TemplateMailPage/ComponentFilter";
import {bindActionCreators} from 'redux';
import {hideSmartMessageBox, putToastSuccess, SmartMessageBox, createPopup} from "actions/uiAction";
import CanRender from "components/Common/Ui/CanRender";
import ROLES from "utils/ConstantActionCode";
import PopupForm from "pages/EmailMarketing/TemplateMailPage/Popup/PopupForm";
...
const idKey = "EmailMarketingTemplateMailList";
        ...
        this.state = {
            columns: [
                ...
                },
                {
                    ...
                    width: 120,
                    cell: row =>
                        <SpanCommon idKey={Constant.COMMON_DATA_KEY_email_marketing_template_status}
                                    value={row?.status}/>,
                },
                {
                    title: "Hành động",
