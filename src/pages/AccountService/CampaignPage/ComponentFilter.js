...
class ComponentFilter extends Component {
    ...
    render() {
        ...
        let status = utils.convertArrayValueCommonData(this.props.sys.common.items, Constant.COMMON_DATA_KEY_status_campaign);
        let channels = [];
        ...
        return (
            <FilterLeft idKey={idKey} query={query} menuCode={menuCode} showQtty={7}>
                ...
                <SearchField type="input" label="Ghi chú" name="note" timeOut={1000} />
                ...
                <SearchField type="datetimerangepicker" label="Ngày bắt đầu" name="start_at" />
            </FilterLeft>
        )
    }
}
