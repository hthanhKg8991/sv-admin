...
import {getDetailQuotationRequest} from "api/saleOrder";
...
class List extends Component {
        ...
        this.state = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    width: 80,
                    cell: row => (
                        <>{row?.week_quantity > 0 ? row?.week_quantity : ""}</>
                    )
                },
                {
                    title: "Thành tiền",
    ...
    render() {
        ...
        return (
            <Default
                title="Danh Sách Gói Dịch Vụ Đăng Ký"
                titleActions={(
                ...
                <Gird idKey={idKey}
                      fetchApi={getDetailQuotationRequest}
                      query={query}
                      columns={columns}
