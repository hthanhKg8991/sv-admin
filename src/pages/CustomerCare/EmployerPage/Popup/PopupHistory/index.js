...
class index extends Component {
    ...
    _refreshList(){
        ...
        this.setState({loading: true},()=>{
            this.props.apiAction.requestApi(apiFn.fnGet, config.apiEmployerDomain, ConstantURL.API_URL_GET_EMPLOYER_REVISION_LIST, args);
        });
    }
    _activeItem(key){
    ...
    componentWillReceiveProps(newProps) {
        if (newProps.api[ConstantURL.API_URL_GET_EMPLOYER_REVISION_LIST]){
            let response = newProps.api[ConstantURL.API_URL_GET_EMPLOYER_REVISION_LIST];
            ...
            this.props.apiAction.deleteRequestApi(ConstantURL.API_URL_GET_EMPLOYER_REVISION_LIST);
                                ...
                                <TableBody tableType="TableBody">
                                    {this.state.data_list.map((item, key)=> {
                                        ...
                                        if (item.revision_reason) {
                                            item.revision_reason.forEach((reason) => {
                                                rejected_reason += '- ' + employer_rejected_reason[reason] + "\n";
                                            });
                                        }
                                        let i = {
