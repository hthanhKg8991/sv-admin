                ...
                <div className="row d-flex align-items-center">
                    <div className="col-sm-6 col-xs-12">
                        <InputImgNormal name={"image" + this.props.keygroup}
                                        folder="employer_library_image"
                                        width={Constant.EMPLOYER_IMAGE_DIMENSION.width/2}
                                        height={Constant.EMPLOYER_IMAGE_DIMENSION.height/2}
                                        maxSize={2} //2M
                                        dimension={Constant.EMPLOYER_IMAGE_DIMENSION}
                                        value={this.state.item.image_path}
                                        onChange={this.handleChangeImage}
                                        error={this.state.errors.image}
                        />
                        {this.state.item.image_path && 
                            <p className="mt5 text-center" style={{width: `${Constant.EMPLOYER_IMAGE_DIMENSION.width/2}px`}}>
