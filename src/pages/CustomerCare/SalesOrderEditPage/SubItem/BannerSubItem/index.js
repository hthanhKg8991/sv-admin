...
import BannerSubItemRow from "pages/CustomerCare/SalesOrderEditPage/SubItem/BannerSubItem/Row";
import PopupBannerPackageRegistration from "pages/CustomerCare/SalesOrderEditPage/Popup/PopupBannerPackageRegistration";

class BannerSubItem extends Component {
    constructor() {
        super();
        this.state = {
            items: null
    ...
    _btnAdd(){
        this.props.uiAction.createPopup(PopupBannerPackageRegistration, "Đăng Ký dịch vụ", {
                    ...
                    (
                        <CanRender actionCode={ROLES.customer_care_sales_order_registration_service_manage}>
                            <button type="button" className="el-button el-button-primary el-button-small" onClick={this.btnAdd}>
                                <span>Đăng ký dịch vụ <i className="glyphicon glyphicon-plus"/></span>
                            </button>
                        </CanRender>
                    )}
                </div>
                                ...
                                <div className="box-card box-full">
                                    ...
                                    <div className="collapse in">
                                        <div className="card-body">
                                            <BannerSubItemRow {...this.props} sub_item={_} data_list={_?.registration_info}/>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(BannerSubItem);