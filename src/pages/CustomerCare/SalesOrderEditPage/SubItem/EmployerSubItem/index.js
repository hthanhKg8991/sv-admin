...
import EmployerSubItemRow from "pages/CustomerCare/SalesOrderEditPage/SubItem/EmployerSubItem/Row";
import PopupEmployerPackageRegistration
    from "pages/CustomerCare/SalesOrderEditPage/Popup/PopupEmployerPackageRegistration";
import moment from "moment";

class EmployerSubItem extends Component {
    constructor() {
        super();
        this.state = {
            items: null
    ...
    _btnAdd(){
        this.props.uiAction.createPopup(PopupEmployerPackageRegistration, "Đăng Ký Điểm Dịch Vụ", {
                                ...
                                <div className="box-card box-full">
                                    ...
                                    <div className="collapse in">
                                        <div className="card-body">
                                            <EmployerSubItemRow {...this.props} sub_item={_} data_list={_?.registration_info}/>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(EmployerSubItem);
