...
import ServicePointPackageRegistration
    from "pages/CustomerCare/SalesOrderEditPage/Package/ServicePointPackage/ServicePointPackageRegistration";
import moment from "moment";
import ROLES from "utils/ConstantActionCode";
import CanRender from "components/Common/Ui/CanRender";
import PopupUpdateInfoSub from "pages/CustomerCare/SalesOrderPage/Popup/PopupUpdateInfoSub";
class ServicePointSubItemRow extends Component {
    constructor() {
        super();
    ...
    render() {
        ...
        return (
            <div>
                ...
                <ServicePointPackageRegistration
...
export default connect(mapStateToProps, mapDispatchToProps)(ServicePointSubItemRow);
