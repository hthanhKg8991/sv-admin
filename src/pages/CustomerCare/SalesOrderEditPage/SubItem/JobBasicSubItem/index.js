...
import JobBasicSubItemRow from "pages/CustomerCare/SalesOrderEditPage/SubItem/JobBasicSubItem/Row";
import PopupJobBasicRegistration from "pages/CustomerCare/SalesOrderEditPage/Popup/PopupJobBasicRegistration";
import moment from "moment";

class JobBasicSubItem extends Component {
    constructor() {
        super();
        this.state = {
            items: null
    ...
    _btnAdd() {
        this.props.uiAction.createPopup(PopupJobBasicRegistration, this.props.isFreemium ? "Đăng Ký Tin Freemium" : "Đăng Ký Tin Cơ Bản" , {
            sales_order: this.props.sales_order,
            sales_order_item: this.props.sales_order_item,
            isFreemium: this.props.isFreemium || false,
            combo: this.props.combo || false
        });
    }
                                ...
                                <div className="box-card box-full">
                                    ...
                                    <div className="collapse in">
                                        <div className="card-body">
                                            <JobBasicSubItemRow {...this.props} sub_item={_} data_list={_?.registration_info}/>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(JobBasicSubItem);
