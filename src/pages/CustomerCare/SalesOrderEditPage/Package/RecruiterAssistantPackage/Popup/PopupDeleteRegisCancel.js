...
class PopupDeleteRegisCancel extends Component {
    constructor(props) {
        super(props);
        this.state = {
                    ...
                    <div className="popupContainer">
                        <div className="form-container row">
                            <div className="col-sm-12 col-xs-12 mb10">
                                <Input2 type="text" name="rejected_note" label="Lý do hủy" required={object_required.includes('rejected_note')}
...
export default connect(mapStateToProps,mapDispatchToProps)(PopupDeleteRegisCancel);
