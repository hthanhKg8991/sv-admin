...
import PopupJobBasic from 'pages/CustomerCare/SalesOrderEditPage/Package/Popup/PopupJobBasic';
...
import JobBasicSubItem from "pages/CustomerCare/SalesOrderEditPage/SubItem/JobBasicSubItem";
...
class index extends Component {
    ...
    _btnGift(name) {
        this.props.uiAction.createPopup(PopupJobBasic, `Đăng Ký ${name} (Tặng)`, {
            sales_order: this.props.sales_order,
    ...
    componentWillReceiveProps(newProps) {
        ...
        const keyRefresh = this.props?.items?.id ? `JobBasicProductGroupPackage${this.props?.items?.id}`:"JobBasicPackage";
    ...
    render() {
        ...
        let {sales_order, is_action = true, isOutdated = false, sys, combo} = this.props;
                                            ...
                                            <div className="left">
                                                <CanRender actionCode={ROLES.customer_care_sales_order_registration_service_manage}>
                                                    {[Constant.CAMPAIGN_TYPE_DEFAULT, Constant.CAMPAIGN_TYPE_EXCHANGE].includes(sales_order?.type_campaign) &&
                                                        ...
                                                        <span>Mua {detailService?.display_name_frontend || detailService?.display_name_contract} <i
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <span>Mua {detailService?.display_name_frontend || detailService?.display_name_contract} (Tặng) <i
                                                            className="glyphicon glyphicon-plus"/></span>
                                                    </button>
                                                </CanRender>
                                            </div>
