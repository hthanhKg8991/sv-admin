...
import PopupFreemium from 'pages/CustomerCare/SalesOrderEditPage/Package/Popup/PopupFreemium';
...
class index extends Component {
    ...
    _btnEdit(object,name) {
        this.props.uiAction.createPopup(PopupFreemium, "Chỉnh Sửa Mua Tin "+name, {
            sales_order: this.props.sales_order,
            object: object,
            type_campaign: object?.type_campaign
        });
                                                    ...
                                                    <CanRender actionCode={ROLES.customer_care_sales_order_registration_service_manage}>
                                                        {[Constant.CAMPAIGN_TYPE_DEFAULT, Constant.CAMPAIGN_TYPE_EXCHANGE].includes(sales_order?.type_campaign) &&
                                                            <button type="button"
                                                                ...
                                                                <span>Mua gói đăng {detailService?.display_name_frontend || detailService?.display_name_contract} <i
                                                            ...
                                                            <React.Fragment key={key}>
                                                                <tr className={classnames("el-table-row pointer")}>
                                                                    ...
                                                                    <td onClick={() => {
                                                                        ...
                                                                        <div className="cell-custom">
                                                                            <div className="mb-8">
                                                                                <div>Thành tiền tin {detailService?.display_name_frontend || detailService?.display_name_contract}: <span
