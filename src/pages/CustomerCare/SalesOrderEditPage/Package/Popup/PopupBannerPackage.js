...
class PopupBannerPackage extends Component {
    constructor(props) {
        ...
        this.state = {
            object: {},
            object_required: ['service_code', 'start_date', 'week_quantity', 'sku_code_service','displayed_area'],
            object_error: {},
            name_focus: "",
    ...
    render() {
        ...
        if (channel_code === Constant.CHANNEL_CODE_MW) {
            object.displayed_area = Constant.DEFAULT_VALUE_FORM_BANNER[channel_code].displayed_area;
        }
