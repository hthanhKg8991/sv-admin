...
import {SERVICE_TYPE_JOB_FREEMIUM} from "utils/Constant";

moment.tz.setDefault("Asia/Ho_Chi_Minh");

class PopupJobFree extends Component {
    constructor(props) {
        super(props);
        ...
        const weekQuantity = Constant.JOB_BASIC_WEEK_QUANTITY_DEFAULT
        this.state = {
            checked: false,
            object: {
                week_quantity: weekQuantity,
            },
            object_required: ['service_code', 'job_quantity', 'start_date', 'week_quantity', 'sku_code_service', 'expired_date'],
            object_error: {},
            name_focus: "",
    ...
    componentDidMount() {
        ...
        if (object) {
            ...
            // Mặc định trigger onChange gói tin Free
    ...
    componentWillReceiveProps(newProps) {
        const keyRefresh = this.props?.items_group_id ? `JobFreeProductGroupPackage${this.props?.items_group_id}`:"JobFreePackage";
                    ...
                    <div className="popupContainer">
                        <div className="form-container row">
                            ...
                            <div className="col-sm-12 col-xs-12 padding0">
                                ...
                                <div className="col-sm-6 col-xs-12 mb10">
                                    <DateTimePicker name="expired_date" label="Ngày hết hạn sử dụng"
                                                    required={object_required.includes('expired_date')} minDate={moment()}
                                                    error={object_error.expired_date} value={object.expired_date}
                                                    nameFocus={name_focus}
                                                    onChange={this.onChange}
                                    />
                                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(PopupJobFree);
