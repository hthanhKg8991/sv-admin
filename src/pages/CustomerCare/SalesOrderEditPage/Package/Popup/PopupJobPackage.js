                    ...
                    <div className="popupContainer">
                        <div className="form-container row">
                            ...
                            <div className="col-sm-12 col-xs-12 padding0">
                                ...
                                <div className="col-sm-4 col-xs-12 mb10">
                                  {object.displayed_area !== 3 && object.displayed_area !== null && <Dropbox name="displayed_area" label="Khu vực hiển thị" data={area} required={object_required.includes('displayed_area')}
