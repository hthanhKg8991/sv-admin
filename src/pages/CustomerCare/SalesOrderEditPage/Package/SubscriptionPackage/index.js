...
import PopupSubscriptionGroupPackage from 'pages/CustomerCare/SalesOrderEditPage/Package/Popup/PopupSubscriptionGroupPackage';
import DetailPackage from "pages/CustomerCare/SalesOrderEditPage/Package/SubscriptionPackage/DetailGroupPackage";
...
import {deleteGroupSubscriptionItem, getListGroupSubscriptionItem,getSuggestCombo} from "api/saleOrder";

const idKey = Constant.IDKEY_SUBSCRIPTION_PACKAGE;
...
class index extends Component {
    ...
    async _asyncData() {
        ...
        const res = await getListGroupSubscriptionItem(args);
        if (res) {
    ...
    async _btnAddGroup() {
        ...
        if(res){
            this.props.uiAction.SmartMessageBox({
                ...
                this.props.uiAction.createPopup(PopupSubscriptionGroupPackage, "Thêm Subscription", {
    ...
    _btnDelete(id) {
        this.props.uiAction.SmartMessageBox({
            title: "Bạn có chắc muốn xóa Subscription ?",
            content: "",
            buttons: ['No', 'Yes']
        }, async (ButtonPressed) => {
            if (ButtonPressed === "Yes") {
                const res = await deleteGroupSubscriptionItem({id:id});
                if (res) {
            ...
            <div className="col-result-full crm-section">
                <div className="box-card box-card-group box-full">
                    <div className="box-card-title pointer box-package-combo" onClick={this.showHide}>
                        <span className="title left">Nhóm Subscription</span>
