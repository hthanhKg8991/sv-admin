...
class PopupSale extends Component {
    ...
    _onSave(data){
        ...
        if (check.error) {
            this.setState({name_focus: check.field, object_error: check.fields, loading: false});
            return;
        }
                        ...
                        <div className="form-container row">
                            ...
                            <div className="col-sm-12 col-xs-12 padding0">
                                <div className="col-sm-6 col-xs-12 mb10">
                                    <Input2 type="text" name="percent_rate" label="Tỉ lệ (%)" isNumber suffix=" %"
                                            error={object_error.percent_rate} value={object.percent_rate} nameFocus={name_focus}
                                            onChange={this.onChange}
                                    />
                                </div>
                                <div className="col-sm-6 col-xs-12 mb10">
                                    <Input2 type="text" name="cash_amount" label="Tiền mặt" isNumber suffix=" đ"
