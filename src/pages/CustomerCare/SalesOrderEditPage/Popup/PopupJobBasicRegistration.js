...
class PopupJobBasicRegistration extends Component {
    constructor(props) {
        super(props);
    ...
    render () {
        ...
        let {object, object_error, object_required, name_focus, listJob, object_effect, configForm} = this.state;
        /**
        ...
        let occupation = [];
        if (this?.props?.combo?.industry_selectable){
                ...
                <div className="dialog-popup-body">
                    <div className="popupContainer">
                        <div className="form-container row">
                            ...
                            {this?.props?.combo?.industry_selectable && (
                                <div className="col-sm-12 col-xs-12 mb10">
                                    {isFieldMulti ? (
...
export default connect(mapStateToProps,mapDispatchToProps)(PopupJobBasicRegistration);
