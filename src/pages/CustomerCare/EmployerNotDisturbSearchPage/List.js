...
import {interrogationEmployerNotDisturb} from "api/employer";
...
class List extends Component {
    ...
    async _onChangeFileImport(event) {
        ...
        if(Constant.EXTENSION_FILE_IMPORT.includes(ext)) {
            ...
            const resImport = await interrogationEmployerNotDisturb(body);
            if(resImport) {
    ...
    render() {
        ...
        return (
            <Default
                title="Tra Cứu NTD cấm làm phiền"
                buttons={(
                    <>
                        {showMessage && (
                        ...
                        <div className="left btnCreateNTD">
                            <CanRender actionCode={ROLES.customer_care_employer_not_disturb_interrogation}>
                ...
                <ul>
                    ...
                    <li>Cột 1 là cột Email/SDT cần tra cứu (Bắt đầu lấy giá trị từ ô A1)</li>
                </ul>
            </Default>
        )
    }
