...
import PlanTomorrowMember from './PlanTomorrowMember'
import * as utils from "utils/utils";

class PlanTomorrowTeam extends Component {
    constructor(props) {
        super(props);
        this.state = {
            item: props.item,
    ...
    render () {
        ...
        return(
            <React.Fragment>
                ...
                {itemActive[item.id] && (
                    <PlanTomorrowMember colSpan={9} {...item}/>
                )}
            </React.Fragment>
        )
    }
...
export default connect(mapStateToProps,mapDispatchToProps)(PlanTomorrowTeam);
