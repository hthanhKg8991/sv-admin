...
import {createOpportunityEmailTemplate, updateOpportunityEmailTemplate} from "api/saleOrder";
...
class Edit extends React.Component {
    ...
    async submitData(data, setErrors) {
        ...
        if (object?.id > 0) {
            data.id = object.id;
            res = await updateOpportunityEmailTemplate(data);
        } else {
            res = await createOpportunityEmailTemplate(data);
        }
        if (res) {
