...
import {getListSalesOrderJobOld} from 'api/saleOrder';
...
class ListJobPremium extends React.Component {
        ...
        this.state = {
            columns: [
                ...
                },
                {
                    ...
                    cell: row => (
                        <React.Fragment>
                            {row.start_date && moment.unix(row.start_date).format("DD/MM/YYYY")}
                        </React.Fragment>
                    )
                },
                {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <ComponentFilter idKey={"SalesOrderJobOld"} type={2}/>
                <div className={"row mt15"}>
                    <div className={"col-md-12"}>
                        <Gird idKey={"SalesOrderJobOld"} fetchApi={getListSalesOrderJobOld}
                              defaultQuery={{}}
                              columns={columns}
                              history={history}
                              isPushRoute={false}
...
export default connect(null, mapDispatchToProps)(ListJobPremium)
