            ...
            columns: [
                {
                    ...
                    cell: row => (
                        <Link
                            target={"_blank"}
                            to={`${Constant.BASE_URL_SALES_SERVICE_PRICE}?${queryString.stringify({
                                id: row.id,
                                action: "detail"
                            })}`}>
                ...
                },
                {
                    ...
                    cell: row => {
                        ...
                        let total = 0;
                        if(row?.total_amount){
                            total = row?.is_include_tax === true ? row?.total_amount : row?.total_amount*taxRate;
                        }
