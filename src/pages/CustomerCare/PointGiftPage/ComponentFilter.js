...
class ComponentFilter extends Component {
    ...
    render () {
        ...
        const status = utils.convertArrayValueCommonData(sys.common.items,Constant.COMMON_DATA_KEY_point_gift_status);

        return (
            <FilterLeft idKey={idKey} query={query} menuCode={menuCode}>
                <SearchField type="input" label="ID NTD" name="employer_q" timeOut={1000}/>
