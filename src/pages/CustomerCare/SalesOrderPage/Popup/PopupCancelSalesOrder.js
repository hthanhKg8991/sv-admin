...
import {salesOrderCancel} from "api/saleOrder";
import {publish} from "utils/event";
import * as Constant from "utils/Constant";

class PopupCancelSalesOrder extends Component {
    constructor(props) {
        super(props);
        this.state = {
            object: {},
    ...
    async _onSave(data) {
        ...
        const res = await salesOrderCancel(object);
        if (res) {
                    ...
                    <div className="popupContainer">
                        <div className="form-container row">
                            <div className="col-sm-12 col-xs-12 mb10">
                                <Input2 type="text" name="rejected_note" label="Lý do"
                                        required={object_required.includes('rejected_note')}
                                        error={object_error.rejected_note} value={object.rejected_note}
...
export default connect(mapStateToProps, mapDispatchToProps)(PopupCancelSalesOrder);
