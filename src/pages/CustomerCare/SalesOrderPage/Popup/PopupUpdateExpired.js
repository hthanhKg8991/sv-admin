...
class PopupUpdateExpired extends Component {
    ...
    render() {
        ...
        const salesOrderStatus = utils.convertArrayValueCommonData(this.props.sys.common.items, Constant.COMMON_DATA_KEY_sales_order_status);
        return (
            <form onSubmit={(event) => {
                                ...
                                <div className="form-container">
                                    ...
                                    <div className="row d-flex align-items-center mb10">
                                        ...
                                        <div className="col-md-4">
                                            <SpanCommon idKey={Constant.COMMON_DATA_KEY_sales_order_status}
