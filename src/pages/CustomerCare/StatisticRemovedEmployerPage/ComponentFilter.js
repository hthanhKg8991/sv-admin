...
class ComponentFilter extends Component {
    ...
    _onSearch(params){
        ...
        this.props.uiAction.refreshList('StatisticRemovedEmployerPage');
    }
    _getCustomerCare(){
    ...
    render () {
        ...
        return (
            <BoxSearch showQtty={4} onChange={this.onSearch}>
                <SearchField type="datetimerangepicker" label="Thời gian xả" name="assigned" ranges={ranges} noDelete/>
