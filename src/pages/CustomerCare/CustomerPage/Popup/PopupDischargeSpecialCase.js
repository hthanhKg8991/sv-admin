...
import {dischargeSpecialCase} from "api/employer";

class PopupDischargeSpecialCase extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            item: props.object,
    ...
    async submitData(data, setErrors) {
        ...
        data.customer_id = id;
        const res = await dischargeSpecialCase(data);
        if (res) {
                            ...
                            <React.Fragment>
                                <div className={"row"}>
                                    <div className="col-sm-12 sub-title-form mb10">
                                        <span>Lý do xả khỏi phòng special case</span>
                                    </div>
                                </div>
                                <div className={"row"}>
...
export default connect(null, mapDispatchToProps)(PopupDischargeSpecialCase);
