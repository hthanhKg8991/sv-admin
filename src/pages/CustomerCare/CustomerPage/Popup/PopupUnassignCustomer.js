...
import {unAssignCustomer} from "api/employer";
...
class PopupUnassignCustomer extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            item: props.object,
    ...
    async submitData(data, setErrors) {
        const {actions, object, idKey, employer_id} = this.props;
        data.employer_id = employer_id;
        const res = await unAssignCustomer(data);
        if (res) {
                            ...
                            <React.Fragment>
                                <div className={"row"}>
                                    <div className="col-sm-12 sub-title-form mb10">
                                        <span>Lý do xả khỏi Customer</span>
                                    </div>
                                </div>
                                <div className={"row"}>
...
export default connect(null, mapDispatchToProps)(PopupUnassignCustomer);
