...
import {moveSpecialCase} from "api/employer";

import FormBase from "components/Common/Ui/Form";
import LoadingSmall from "components/Common/Ui/LoadingSmall";
import MyField from "components/Common/Ui/Form/MyField";

class PopupMoveSpecialCase extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            item: props.object,
    ...
    async submitData(data, setErrors) {
        ...
        data.customer_id = id;
        const res = await moveSpecialCase(data);
        if (res) {
                            ...
                            <React.Fragment>
                                <div className={"row"}>
                                    <div className="col-sm-12 sub-title-form mb10">
                                        <span>Lý do trả về  phòng special case</span>
                                    </div>
                                </div>
                                <div className={"row"}>
...
export default connect(null, mapDispatchToProps)(PopupMoveSpecialCase);
