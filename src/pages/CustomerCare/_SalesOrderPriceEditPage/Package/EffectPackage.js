...
import PopupEffectPackage from '../Popup/PopupEffectPackage';
...
class EffectPackage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: true,
    ...
    _btnEdit(object){
        this.props.uiAction.createPopup(PopupEffectPackage, "Chỉnh Sửa Mua Hiệu Ứng", {
            ...
            <div className="col-result-full crm-section">
                <div className="box-card box-full">
                    <div className="box-card-title pointer box-package" onClick={this.showHide}>
                        <span className="title left">Hiệu ứng ({data_list.length})</span>
...
export default connect(mapStateToProps,mapDispatchToProps)(EffectPackage);
