...
import PopupBannerPackage from '../Popup/PopupBannerPackage';
...
class BannerPackage extends Component {
    ...
    _btnBuy(){
        this.props.uiAction.createPopup(PopupBannerPackage, "Mua dịch vụ", {sales_order: this.props.sales_order});
    }
    ...
    _btnEdit(object){
        this.props.uiAction.createPopup(PopupBannerPackage, "Chỉnh Sửa Mua dịch vụ", {
    ...
    _btnDelete(object){
        this.props.uiAction.SmartMessageBox({
            title: "Bạn có chắc muốn xóa gói dịch vụ ?",
            content: "",
            buttons: ['No','Yes']
        }, (ButtonPressed) => {
            ...
            <div className="col-result-full crm-section">
                <div className="box-card box-full">
                    <div className="box-card-title pointer box-package" onClick={this.showHide}>
                        <span className="title left">Quảng báo thương hiệu ({data_list.length})</span>
                                    ...
                                    {parseInt(sales_order.status) !== Constant.STATUS_DELETED &&(
                                        <div className="left">
                                            <button type="button" className="el-button el-button-primary el-button-small" onClick={this.btnBuy}>
                                                <span>Mua Quảng bá thương hiệu <i className="glyphicon glyphicon-plus"/></span>
                                            </button>
                                        </div>
                                    )}
                                    <div className="right">
...
export default connect(mapStateToProps,mapDispatchToProps)(BannerPackage);
