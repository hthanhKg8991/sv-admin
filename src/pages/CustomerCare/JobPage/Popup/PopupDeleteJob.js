...
class PopupDeleteJob extends Component {
    constructor(props) {
        super(props);
        this.state = {
            objectLock: {},
            objectLock_error: {},
            objectLock_required: ['deleted_reason'],
            name_focus: ''
        };
    ...
    _onSave(event){
        ...
        this.props.apiAction.requestApi(apiFn.fnPost, config.apiEmployerDomain, ConstantURL.API_URL_POST_JOB_DELETE, objectLock);
                ...
                <div className="popupContainer">
                    <div className="row form-container">
                        <div className="col-sm-12 col-xs-12 mb15 mt10">
                            <InputArea name="deleted_reason"
                                       label="Lý do xóa"
                                       required={objectLock_required.includes('deleted_reason')}
                                       nameFocus={name_focus}
                                       style={{ minHeight: "102px" }}
                                       value={objectLock.deleted_reason}
                                       error={objectLock_error.deleted_reason}
...
export default connect(mapStateToProps,mapDispatchToProps)(PopupDeleteJob);
