...
class index extends Component {
    ...
    _refreshList(){
        ...
        this.setState({loading: true},()=>{
            this.props.apiAction.requestApi(apiFn.fnGet, config.apiEmployerDomain, ConstantURL.API_URL_GET_LIST_JOB_REVISION, args);
        });
    }
    _activeItem(key){
    ...
    componentWillReceiveProps(newProps) {
        if (newProps.api[ConstantURL.API_URL_GET_LIST_JOB_REVISION]){
            let response = newProps.api[ConstantURL.API_URL_GET_LIST_JOB_REVISION];
            ...
            this.props.apiAction.deleteRequestApi(ConstantURL.API_URL_GET_LIST_JOB_REVISION);
