...
class HistoryChangeCompany extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            columns: [
        ...
        return (
            <div className={`${!isShow && "hidden"}`}>
                {!employer_id ? (
                    ...
                    <h3 className="mb20 mt30">Lịch sử yêu cầu đổi tên công ty</h3>
                )}
...
export default connect(null, mapDispatchToProps)(HistoryChangeCompany)
