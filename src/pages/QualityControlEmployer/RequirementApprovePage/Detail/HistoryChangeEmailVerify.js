...
class HistoryChangeEmailVerify extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            columns: [
                ...
                },
                {
                    ...
                    cell: row => (
                        <>
                            <span>{row?.employer_info?.email}</span>
                        </>
                    )
                },
                {
                ...
                },
                {
                    ...
                    cell: row => (
                        <>
                            {row.file_path && (
                                <a href={row.file_path} target="_blank" rel="noopener noreferrer">Tải file</a>
                            )}
                        </>
                    )
                },
        ...
        return (
            <div className={`${!isShow && "hidden"}`}>
                {!employer_id ? (
                    ...
                    <h3 className="mb20 mt30">Lịch sử yêu cầu xác thực email</h3>
                )}
...
export default connect(null, mapDispatchToProps)(HistoryChangeEmailVerify)
