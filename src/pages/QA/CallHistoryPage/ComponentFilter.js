...
class ComponentFilter extends Component {
    ...
    render() {
        let feedback_status = utils.convertArrayValueCommonData(this.props.sys.common.items, Constant.COMMON_DATA_KEY_call_feedback_status);
        let call_status = utils.convertArrayValueCommonData(this.props.sys.common.items, Constant.COMMON_DATA_KEY_call_review_status);
        let labels = utils.convertArrayValueCommonData(this.props.sys.common.items, Constant.COMMON_DATA_KEY_call_center_label);
        ...
        return (
            <BoxSearch showQtty={4} onChange={this.onSearch}>
                <SearchField  noDelete={true} type="datetimerangepicker" label="Thời gian gọi" name="date"
                             ranges={ranges}/>
                ...
                <SearchField type="dropbox" label="Nhãn cuộc gọi" name="label" data={labels}/>
                <SearchField type="dropbox" label="Nhóm CSKH" name="team_id" key_value="id" key_title="name"
                             data={team_list}/>
                <SearchField type="dropboxmulti" label="CSKH" name="staff_id" key_value="id" key_title="login_name"
                             data={staff_list}/>
                <SearchField type="dropbox" label="Tình trạng chấm điểm" name="qa_evaluation_status"
                             data={call_status}/>
                <SearchField type="dropbox" label="CSKH phản hồi" name="member_note" data={feedback_status}/>
                <SearchField type="dropbox" label="trưởng nhóm phản hồi" name="leader_note" data={feedback_status}/>
            </BoxSearch>
        )
    }
}
