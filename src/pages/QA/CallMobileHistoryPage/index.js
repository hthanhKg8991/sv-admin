...
class index extends Component {
    ...
    _refreshList(delay = 0){
        ...
        this.props.apiAction.requestApi(apiFn.fnGet, config.apiCallDomain, ConstantURL.API_URL_CALL_HISTORY_LIST, {...params, type: 2}, delay);
    ...
    componentWillReceiveProps(newProps) {
        ...
        if (newProps.api[ConstantURL.API_URL_CALL_EXPORT]){
            ...
            if (response.code === Constant.CODE_SUCCESS) {
                ...
                window.open(config.urlCdnExcel + "/" + response.data);
            }
            this.props.uiAction.hideLoading();
                ...
                <div className="col-result">
                    <div className="box-card">
                        <div className="box-card-title">
                            <span className="title left">Danh Sách Lịch Sử Cuộc Gọi Di Động</span>
                            <div className="right">
