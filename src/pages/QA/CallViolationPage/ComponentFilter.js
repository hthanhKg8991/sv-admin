...
class ComponentFilter extends Component {
    ...
    _onSearch(params){
        ...
        this.props.uiAction.refreshList('CallViolationPage');
    }
    _getCustomerCare(){
    ...
    render () {
        ...
        return (
            <BoxSearch showQtty={4} onChange={this.onSearch}>
                <SearchField type="datetimerangepicker" label="Thời gian gọi" name="date" ranges={ranges} valueDefault={[this.state.startDate,this.state.endDate]}/>
