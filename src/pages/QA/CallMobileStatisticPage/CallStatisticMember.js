...
class CallStatisticMember extends Component {
    ...
    _refreshList(delay = 0){
        ...
        this.setState({loading: true},()=>{
            this.props.apiAction.requestApi(apiFn.fnGet, config.apiCallDomain, ConstantURL.API_URL_CALL_STATISTIC_MEMBER_LIST, {...params, type: 2}, delay);
        });
    }
    ...
    render () {
        ...
        let url_history = Constant.BASE_URL_CALL_MOBILE_HISTORY;
        return(
            <React.Fragment>
