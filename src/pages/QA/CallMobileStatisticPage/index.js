...
import PopupGetCall from "pages/QA/CallMobileStatisticPage/Popup/PopupGetCall";
import CanRender from "components/Common/Ui/CanRender";
import ROLES from "utils/ConstantActionCode";

class CallMobileStatisticPage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data_list: [],
    ...
    _refreshList(delay = 0){
        ...
        this.props.apiAction.requestApi(apiFn.fnGet, config.apiCallDomain, ConstantURL.API_URL_CALL_STATISTIC_TEAM_LIST, {...params, type: 2}, delay);
    ...
    componentWillReceiveProps(newProps) {
        ...
        if (newProps.refresh['CallMobileStatisticPage']){
            let delay = newProps.refresh['CallMobileStatisticPage'].delay ? newProps.refresh['CallMobileStatisticPage'].delay : 0;
            this.refreshList(delay);
            this.props.uiAction.deleteRefreshList('CallMobileStatisticPage');
        }
        ...
        return (
            <div className="row-body">
                <div className="col-search">
                    <CustomFilter name="CallMobileStatisticPage"/>
                    <ComponentFilter history={this.props.history}/>
                </div>
                <div className="col-result">
                    <div className="box-card">
                        <div className="box-card-title">
                            <span className="title left">Danh Sách Thống Kê Cuộc Gọi Di Động</span>
                            <div className="right">
                        ...
                        <div className="card-body">
                            <div className="top-table">
                                <div className="left btnCreateNTD">
                                    <CanRender actionCode={ROLES.qa_call_mobile_statistic_get_call}>
...
export default connect(mapStateToProps,mapDispatchToProps)(CallMobileStatisticPage);
