            ...
            <React.Fragment>
                ...
                <div className="row">
                    <div className="col-md-6 mb10">
                        <MyField name={"code"} label={"Mã nhân viên"} showLabelRequired/>
                    </div>
                    <div className="col-md-6 mb10">
                        <MyField name={"name"} label={"Tên nhân viên"} showLabelRequired/>
                    </div>
                </div>
                <div className="row">
                    <div className="col-md-6 mb10">
                        <MySelectSystem name={"position"} label={"Chức vụ"}
                                        type={"common"}
                                        valueField={"value"}
                ...
                <div className="row">
                    <div className="col-md-6 mb10">
                        <MySelectSearch name={"group_code"} label={"Group"}
