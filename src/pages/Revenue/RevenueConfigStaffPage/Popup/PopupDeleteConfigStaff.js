...
import {getListConfigKpi,deleteConfigStaffV2} from "api/commission";
import Dropbox from 'components/Common/InputValue/Dropbox';
import LoadingSmall from "components/Common/Ui/LoadingSmall";

class PopupDeleteConfigStaff extends Component {
    constructor(props) {
        super(props);
        this.state = {
            object: {},
    ...
    async _onSave(data) {
        ...
        uiAction.SmartMessageBox({
            ...
            if (ButtonPressed === "Yes") {
                ...
                const res = await deleteConfigStaffV2(object);
                if (res) {
    ...
    render() {
        ...
        return (
            ...
            :   <div className="dialog-popup-body"><div className="popupContainer text-center"><LoadingSmall /></div></div>
            }
            </>
        )
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(PopupDeleteConfigStaff);
