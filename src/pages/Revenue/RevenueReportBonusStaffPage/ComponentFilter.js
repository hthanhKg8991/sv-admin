            ...
            <div className="row mt-15 d-flex">
                <Filter idKey={idKey} query={query} menuCode={menuCode} initFilter={{config_id: query?.config_id}}>
                    ...
                    <SearchField className="col-md-3" type="dropbox" label="Cấu hình" name="config_id"
                                 data={config_list}/>
                    <SearchField className="col-md-3" type="dropbox" label="Team" name="staff_group_code"
                                 data={group_list}/>
                    <SearchField className="col-md-3" type="dropbox" label="Vị trí" name="staff_position"
                                 data={position}/>
                </Filter>
            </div>
        )
