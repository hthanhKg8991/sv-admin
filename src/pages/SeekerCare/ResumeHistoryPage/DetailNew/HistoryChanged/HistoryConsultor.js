...
class HistoryConsultor extends Component {
    ...
    render () {
        ...
        const isEmail = [Constant.CHANNEL_CODE_TVN, Constant.CHANNEL_CODE_MW].includes(channel_code);
            ...
            <TableComponent allowDragScroll={false} className="mt15">
                ...
                <TableBody tableType="TableBody">
                    {data_list.map((item, key)=> {
                        ...
                        if(isEmail) {
                            data_change = {...data_change, email: item?.email};
                            old_data = {...old_data, email: item?.old_data?.email};
                        }
                        return(
