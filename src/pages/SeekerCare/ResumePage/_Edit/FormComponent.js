                ...
                <div className={"row"}>
                    <div className="col-sm-9 mb10">
                        ...
                        <div className={"row"}>
                            ...
                            <div className="col-sm-12 mb10">
                                <MyPassword name={"password"} label={"Mật khẩu"} type={"password"}/>
                            </div>
                            <div className="col-sm-12 mb10">
                    ...
                    <div className="col-sm-3 mb10">
                        <DropzoneImage label={"Avatar"} name={"avatar"}
                ...
                <div className={"row"}>
                    ...
                    <div className="col-sm-3 mb10">
                        <MySelectFetch name={"assigned_staff_id"} label={"CSNTV"}
                                       ...
                                       fetchFilter={{
                                           'division_code[0]': Constant.DIVISION_TYPE_seeker_care_member,
                                           'division_code[1]': Constant.DIVISION_TYPE_seeker_care_leader,
                                           execute: true,
                                           scopes: true,
