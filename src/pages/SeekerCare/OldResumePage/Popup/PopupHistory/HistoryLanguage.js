            ...
            <TableComponent allowDragScroll={false} className="mt15">
                ...
                <TableBody tableType="TableBody">
                    {data_list.map((item, key)=> {
                        let data_change = {
                            language: language_resume[item.language] ? language_resume[item.language] : item.language,
                            level: language_resume_rate[item.level] ? language_resume_rate[item.level] : item.level,
                        ...
                        let old_data = {
                            language: language_resume[item.old_data.language] ? language_resume[item.old_data.language] : item.old_data.language,
                            level: language_resume_rate[item.old_data.level] ? language_resume_rate[item.old_data.level] : item.old_data.level,
