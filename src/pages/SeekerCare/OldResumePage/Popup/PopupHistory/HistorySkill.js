                ...
                <TableComponent allowDragScroll={false} className="mt15 table-custom">
                    ...
                    <TableBody tableType="TableBody">
                        {data_list.map((item, key)=> {
                            let data_change = {
                                special_skill: item.special_skill,
                                interesting: item.interesting,
                            };

                            let old_data = {
                                special_skill: item.old_data.special_skill,
                                interesting: item.old_data.interesting,
                            };
                            let skills_old = item.old_data && item.old_data.skills ? item.old_data.skills.split(",") : [];
