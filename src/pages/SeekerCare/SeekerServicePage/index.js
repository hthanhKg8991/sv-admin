...
class index extends Component {
    ...
    _refreshList(delay = 0){
        ...
        params['division_type'] = Constant.DIVISION_SEEKER;
    ...
    _btnAdd(){
        this.props.uiAction.createPopup(PopupCustomerService, "Thêm Nhóm CSNTV");
    }
    _btnDelete(item){
                ...
                <div className="col-result">
                    <div className="box-card">
                        <div className="box-card-title">
                            <span className="title left">Danh Sách Nhóm CSNTV</span>
                            <div className="right">
