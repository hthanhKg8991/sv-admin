...
import PopupJobPackage from "pages/Accountant/BundlesPackagePage/Edit/Package/Popup/PopupJobPackage";
			...
			columns: [
				{
					...
					cell: item => <div className="cell-custom mt5 mb5">
						...
						<div>Khu vực hiển thị: <span
							className="text-bold"><SpanCommon idKey={Constant.COMMON_DATA_KEY_area} value={item?.displayed_area} notStyle /></span>
						</div>
						<div>Hình thức hiển thị: <span
							className="text-bold"><SpanCommon idKey={Constant.COMMON_DATA_KEY_display_method} value={item?.displayed_method} notStyle/></span>
						</div>
