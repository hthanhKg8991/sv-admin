...
class FormComponent extends React.Component {
	...
	render() {
		const {fieldWarnings, values, branch, sys,setFieldValue} = this.props;
			...
			<React.Fragment>
				...
				<div className="row">
					<div className="col-md-6 mb10">
						<MyField name={"code"} label={"Mã Combo"}
				...
				<div className="row">
					<div className="col-md-12 mb15">
						<MyConditionDynamic 
							...
							label={"Điều kiện"} 
							common={common} 
							idKey={Constant.COMMON_DATA_KEY_combo_package_condition_items}
