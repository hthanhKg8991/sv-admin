...
import {createComboItem} from "api/saleOrder";
...
class PopupEmployerPackage extends Component {
	constructor(props) {
		...
		this.state = {
			object: {},
			object_required: ["service_code", "quantity", "sku_code", "type_campaign"],
			object_error: {},
			name_focus: ""
		};
	...
	_onChange(value, name) {
		...
		object[name] = value;
		if (name === "quantity") {
			const pointConfig = this.props.sys.common.items[Constant.COMMON_DATA_KEY_list_price_promotion_point] || [];
						...
						<div className="form-container row">
							...
							<div className="col-sm-12 col-xs-12 padding0">
								<div className="col-sm-6 col-xs-12 mb10">
									<Input2 type="text" name="quantity" label="Điểm mua" isNumber
