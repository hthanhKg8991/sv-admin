...
import Edit from "pages/Accountant/ComboPackagePage/Edit";
import Packages from "pages/Accountant/ComboPackagePage/Edit/Package";
...
class FormContainer extends Component {
	...
	render() {
		...
		const idKey = "ComboPackagePageEdit";

		return (
			<div className="paddingRight25">
				<Default
					title={`${id > 0 ? "Chỉnh Sửa" : "Thêm"} Gói Combo`}
					titleActions={(
