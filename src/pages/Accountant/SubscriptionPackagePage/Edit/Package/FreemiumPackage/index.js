...
import PopupFreemium from "pages/Accountant/SubscriptionPackagePage/Edit/Package/Popup/PopupFreemiumPackage";
...
class index extends Component {
	...
	_btnBuy() {
		this.props.uiAction.createPopup(PopupFreemium, "Mua gói đăng tin miễn phí", {
			id: this.props.id,
	...
	_btnDelete(object) {
		...
		uiAction.SmartMessageBox({
			title: "Bạn có chắc muốn xóa gói đăng tin miễn phí ?",
			content: "",
			buttons: ["No", "Yes"]
		}, async (ButtonPressed) => {
			...
			<div className="col-result-full crm-section">
				<div className="box-card box-full">
					<div className="box-card-title pointer box-package" onClick={this.toggleShow}>
						<span className="title left">Đăng tin miễn phí</span>
									...
									<div className="left">
										<CanRender actionCode={ROLES.accountant_subscription_package_create}>
											<button type="button"
												...
												onClick={this.btnBuy}>
												<span>Mua gói đăng tin tin miễn phí <i
														...
														<tr className={classnames("el-table-row pointer")}
															...
															<td>
																<div className="cell-custom mt5 mb5">
																	...
																	<div>Số tin: <span
																		className="text-bold">{item.quantity < 0 ? "Không giới hạn" : utils.formatNumber(item.quantity, 0, ".", "tin")}</span>
																	</div>
																	<div>Thời gian mua:
