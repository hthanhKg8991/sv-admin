...
import PopupJobBasic from "pages/Accountant/SubscriptionPackagePage/Edit/Package/Popup/PopupJobBasic";
...
class index extends Component {
	...
	_btnBuy() {
		this.props.uiAction.createPopup(PopupJobBasic, "Mua Tin Cơ Bản", {
			id: this.props.id,
			...
			<div className="col-result-full crm-section">
				<div className="box-card box-full">
					<div className="box-card-title pointer box-package" onClick={this.toggleShow}>
						<span className="title left">Tin cơ bản </span>
