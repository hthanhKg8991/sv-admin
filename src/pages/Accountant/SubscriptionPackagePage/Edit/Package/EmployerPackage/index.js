...
import PopupEmployerPackage from "pages/Accountant/SubscriptionPackagePage/Edit/Package/Popup/PopupEmployerPackage";
...
class index extends Component {
	...
	_btnBuy() {
		this.props.uiAction.createPopup(PopupEmployerPackage, "Mua Gói Lọc", {
			id: this.props.id,
	...
	_btnDelete(object) {
		...
		uiAction.SmartMessageBox({
			title: "Bạn có chắc muốn xóa gói lọc ?",
			content: "",
			buttons: ["No", "Yes"]
		}, async (ButtonPressed) => {
			...
			<div className="col-result-full crm-section">
				<div className="box-card box-full">
					<div className="box-card-title pointer box-package" onClick={this.toggleShow}>
						<span className="title left">Điểm dịch vụ</span>
