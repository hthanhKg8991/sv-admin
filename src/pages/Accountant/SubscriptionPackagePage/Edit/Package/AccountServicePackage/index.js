...
import PopupAccountServicePackage from "pages/Accountant/SubscriptionPackagePage/Edit/Package/Popup/PopupAccountServicePackage";
...
class index extends Component {
	...
	_btnBuy() {
		this.props.uiAction.createPopup(PopupAccountServicePackage, "Mua gói Quản lý tài khoản NTD", {
			id: this.props.id,
