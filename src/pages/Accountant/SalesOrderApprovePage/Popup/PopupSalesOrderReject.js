...
class PopupSalesOrderReject extends Component {
	...
	_onSave(){
		...
		this.props.apiAction.requestApi(apiFn.fnPost, config.apiSalesOrderDomain, ConstantURL.API_URL_POST_SALES_ORDER_REJECT, object);
	}
	...
	componentWillReceiveProps(newProps) {
		if (newProps.api[ConstantURL.API_URL_POST_SALES_ORDER_REJECT]){
			let response = newProps.api[ConstantURL.API_URL_POST_SALES_ORDER_REJECT];
			...
			this.props.apiAction.deleteRequestApi(ConstantURL.API_URL_POST_SALES_ORDER_REJECT);
		}
	}
