...
class PopupSalesOrderReject extends Component {
	constructor(props) {
		super(props);
		this.state = {
			object: {},
	...
	_onSave(){
		...
		this.props.apiAction.requestApi(apiFn.fnPost, config.apiSalesOrderDomain, ConstantURL.API_URL_POST_SALES_ORDER_REQUEST_DROP_REJECT, object);
	}
	...
	componentWillReceiveProps(newProps) {
		if (newProps.api[ConstantURL.API_URL_POST_SALES_ORDER_REQUEST_DROP_REJECT]){
			let response = newProps.api[ConstantURL.API_URL_POST_SALES_ORDER_REQUEST_DROP_REJECT];
			...
			this.props.apiAction.deleteRequestApi(ConstantURL.API_URL_POST_SALES_ORDER_REQUEST_DROP_REJECT);
		}
	}
...
export default connect(mapStateToProps,mapDispatchToProps)(PopupSalesOrderReject);
