...
import PopupServicePoint from "pages/Accountant/ComboPostingPackagePage/Edit/Package/Popup/PopupServicePoint";
...
class index extends Component {
  ...
  _btnBuy() {
    this.props.uiAction.createPopup(PopupServicePoint, "Mua Điểm dịch vụ", {
      id: this.props.id,
