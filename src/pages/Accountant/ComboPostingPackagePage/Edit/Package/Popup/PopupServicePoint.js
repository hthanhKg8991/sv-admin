...
class PopupServicePoint extends Component {
  constructor(props) {
    super(props);
    this.state = {
      object: {},
  ...
  async _onSave(data) {
    ...
    object.service_type = Constant.SERVICE_TYPE_SERVICE_POINT;
...
export default connect(mapStateToProps, mapDispatchToProps)(PopupServicePoint);
