...
import Edit from "pages/Accountant/ComboPostingPackagePage/Edit";
import Packages from "pages/Accountant/ComboPostingPackagePage/Edit/Package";
...
class FormContainer extends Component {
	...
	render() {
		...
		const idKey = "ComboPostingPackagePageEdit";

		return (
			<div className="paddingRight25">
				<Default
					title={`${id > 0 ? "Chỉnh Sửa" : "Thêm"} Gói đăng tin Combo`}
					titleActions={(
