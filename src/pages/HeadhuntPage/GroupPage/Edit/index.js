...
import {createHeadhuntGroup, updateHeadhuntGroup} from "api/headhunt";
...
class Edit extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            initialForm: {
                ...
                "list_industry_id": "list_industry_id",
            },
        };
    ...
    async submitData(data, setErrors) {
        ...
        if (object?.id > 0) {
            data.id = object.id;
            res = await updateHeadhuntGroup(data);
        } else {
            res = await createHeadhuntGroup(data);
        }
        if (res) {
