...
import {createMultipleHeadhuntCampaignGroupMember} from "api/headhunt";
...
class Form extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            initialForm: {
                ...
                "list_group_member_login_name": "list_group_member_login_name",
            },
        };
    ...
    async submitData(data, setErrors) {
        ...
        const res = await createMultipleHeadhuntCampaignGroupMember(data);
        if (res) {
    ...
    render() {
        ...
        const validationSchema = Yup.object().shape({
            list_group_member_login_name: Yup.array().required(Constant.MSG_REQUIRED),
        });
