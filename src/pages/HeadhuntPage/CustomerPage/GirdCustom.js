...
class GirdCustom extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    async asyncData(params = {}) {
        ...
        this.setState({indexExpandRow: null})
...
export default connect(mapStateToProps, null)(GirdCustom);
