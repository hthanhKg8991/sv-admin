...
class ComponentFilter extends Component {
    ...
    render() {
        ...
        // const status = utils.convertArrayValueCommonData(this.props.sys.common.items,Constant.COMMON_DATA_KEY_headhunt_job_request_status);

        return (
            <FilterLeft idKey={idKey} query={query} menuCode={menuCode}>
                <SearchField type="input" label="ID, Vị trí tuyển dụng" name="q" timeOut={1000}/>
