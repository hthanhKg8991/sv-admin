            ...
            <div className="v-input">
                <div className={class_error}>
                    <div className="v-input-slot v-date-picker">
                        <DateRangePicker onShow={this.props.onShow} autoApply={this.state.autoApply} startDate={this.state.start} endDate={this.state.end} onApply={this.onApply} showDropdowns linkedCalendars={false}>
