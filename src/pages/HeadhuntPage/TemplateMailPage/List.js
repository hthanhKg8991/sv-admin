...
const idKey = "HeadhuntTemplateMailList";
        ...
        this.state = {
            columns: [
                ...
                },
                {
                    ...
                    cell: row => (
                        <>
                            <CanRender actionCode={ROLES.headhunt_email_template_update}>
                                <span className="text-link text-blue font-bold ml5" onClick={() => this.onEdit(row)}>
                                    Chỉnh sửa
                                </span>
                            </CanRender>
                            <CanRender actionCode={ROLES.headhunt_email_template_toggle}>
                            ...
                            <CanRender actionCode={ROLES.headhunt_email_template_delete}>
                                {row.status !== Constant.HEADHUNT_ACCEPTANCE_RECORD_STATUS_ACTIVE && (
