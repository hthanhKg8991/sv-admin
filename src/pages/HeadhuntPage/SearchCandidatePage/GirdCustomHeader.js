...
import Pagination2Custom from "pages/HeadhuntPage/SearchCandidatePage/Pagination2Custom";
...
class GirdCustomHeader extends React.Component {
    ...
    async asyncData(params = {}) {
        const {defaultQuery, fetchApi, history, query, isPushRoute, onFetchSuccess, isReplaceRoute, setDataFetch} = this.props;
    ...
    _renderTable() {
        ...
        return (
            <React.Fragment>
                ...
                <Pagination2Custom {...pagination} perPage={perPage}
...
GirdCustomHeader.propTypes = {
    ...
    setDataFetch: PropTypes.func, // set data fetch
};
