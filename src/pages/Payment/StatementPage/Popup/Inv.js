...
class PopupInv extends Component {
    constructor(props) {
        super(props);
        this.state = {
            object: {
                inv: props.object.inv
            },
            object_required: ['inv'],
            object_error: {},
            name_focus: "",
                    ...
                    <div className="popupContainer">
                        <div className="form-container row">
                            <div className="col-sm-12 col-xs-12 mb10">
                                <Input2 type="text" name="inv" label="INV"
                                        required={object_required.includes('inv')}
                                        error={object_error.inv}
                                        value={object.inv}
...
export default connect(mapStateToProps, mapDispatchToProps)(PopupInv);
