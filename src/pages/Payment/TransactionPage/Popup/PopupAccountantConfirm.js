...
import {accountantConfirmStatusTransaction} from "api/saleOrder";
import Input2 from "components/Common/InputValue/Input2";
import InputFileMulti from "components/Common/InputValue/InputFileMulti";

moment.tz.setDefault("Asia/Ho_Chi_Minh");

class PopupAccountantConfirm extends Component {
    constructor(props) {
        super(props);
        this.state = {
            object: {
    ...
    async _onSave(data, required) {
        ...
        const res = await accountantConfirmStatusTransaction({...object, id: this.props.id});
        if (res) {
...
export default connect(mapStateToProps, mapDispatchToProps)(PopupAccountantConfirm);
