...
import {updateInternalTransaction} from "api/saleOrder";
import Input2 from "components/Common/InputValue/Input2";

moment.tz.setDefault("Asia/Ho_Chi_Minh");

class PopupUpdateInternal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            object: {
    ...
    async _onSave(data, required) {
        ...
        const res = await updateInternalTransaction({...object, id: this.props.id});
        if (res) {
...
export default connect(mapStateToProps, mapDispatchToProps)(PopupUpdateInternal);
