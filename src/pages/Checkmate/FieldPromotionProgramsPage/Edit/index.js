...
import {
    createFieldPromotionPrograms,
    getDetailFieldPromotionPrograms,
    updateFieldPromotionPrograms,
} from "api/saleOrder";
...
class Edit extends React.Component {
    ...
    async submitData(data, setErrors) {
        ...
        if (id > 0) {
            data.id = id;
            res = await updateFieldPromotionPrograms(data);
        } else {
            res = await createFieldPromotionPrograms(data);
        }
    ...
    async asyncData() {
        ...
        if (id > 0) {
            const res = await getDetailFieldPromotionPrograms({id});
            if (res) {
